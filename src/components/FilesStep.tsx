    ...
    <div className="w-full max-w-lg mt-8 flex flex-col gap-6">
      <div>
        ...
        >
          {driveCount > 0 ? (
            <>
              Encontramos <span className="font-semibold text-[#ee742f]">{driveCount} documentos</span> en tu Drive.
              {" "}Ahora podés sumar archivos desde iCloud, tu iPhone o tu Mac.
            </>
          ) : (
            "Seleccioná documentos médicos desde iCloud, tu iPhone o tu Mac."
          )}
        </p>
      </div>
      ...
      >
        ...
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M14 12h10l6 6v14a2 2 0 0 1-2 2H14a2 2 0 0 1-2-2V14a2 2 0 0 1 2-2z" fill="#2b4c9c" fillOpacity="0.15" stroke="#2b4c9c" strokeWidth="1.5" />
        ...
        <p
          ...
          style={{ fontFamily: "var(--font-inter)" }}
        >
          {dragging ? "Soltá los archivos acá" : "Seleccionar desde Archivos / iCloud"}
        </p>
        <p
          className="text-xs text-[#666666] mt-1"
          style={{ fontFamily: "var(--font-poppins)" }}
        >
          PDF, JPG, PNG, HEIC · Múltiples archivos a la vez
        </p>
        <input
          ref={inputRef}
          type="file"
              ...
              >
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M4 2h6l4 4v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z" fill="#2b4c9c" fillOpacity="0.2" stroke="#2b4c9c" strokeWidth="1" />
